...
var (
	...
	ErrFetchLinkerdVersions = errors.New(ErrFetchLinkerdVersionsCode, errors.Alert, []string{"could not get any linkerd versions"}, []string{"versions for linkerd could not be fetched"}, []string{"could not reach github.com/linkerd/linkerd/releases", "no versions could be fetched from linkerd release page"}, []string{"make sure adapter is reachable to github"})
