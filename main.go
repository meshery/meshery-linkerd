...
import (
	...
	mesh "github.com/layer5io/meshery-linkerd/meshes"
)

var (
	gRPCPort = flag.Int("grpc-port", 10001, "The gRPC server port")
)
...
func main() {
	...
	mesh.RegisterMeshServiceServer(s, &linkerd.LinkerdClient{})
